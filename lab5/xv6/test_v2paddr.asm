...
int main(int argc, char *argv[])
{
  ...
  12:	53                   	push   %ebx
    ...
    getPAddr((int)&test1);
  13:	8d 5d e0             	lea    -0x20(%ebp),%ebx
{
  16:	51                   	push   %ecx
  17:	83 ec 24             	sub    $0x24,%esp
    int test1 = 112001052;
  1a:	c7 45 e0 1c 00 ad 06 	movl   $0x6ad001c,-0x20(%ebp)
    printf(1,"Testing v2paddr() system call\n");
  21:	68 80 08 00 00       	push   $0x880
  26:	6a 01                	push   $0x1
    char* test2 = "ALN";
  28:	c7 45 e4 fe 08 00 00 	movl   $0x8fe,-0x1c(%ebp)
    printf(1,"Testing v2paddr() system call\n");
  2f:	e8 bc 04 00 00       	call   4f0 <printf>
    getPAddr((int)&test1);
  34:	89 1c 24             	mov    %ebx,(%esp)
  37:	e8 b4 00 00 00       	call   f0 <getPAddr>
    getPAddr((int)&test2);
  3c:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  3f:	89 04 24             	mov    %eax,(%esp)
  42:	e8 a9 00 00 00       	call   f0 <getPAddr>
    getPAddr(test3);
  47:	c7 04 24 09 10 00 80 	movl   $0x80001009,(%esp)
  4e:	e8 9d 00 00 00       	call   f0 <getPAddr>
    
    printf(1,"Global variable\n");
  53:	59                   	pop    %ecx
  54:	5e                   	pop    %esi
  55:	68 02 09 00 00       	push   $0x902
  5a:	6a 01                	push   $0x1
  5c:	e8 8f 04 00 00       	call   4f0 <printf>
    getPAddr((int)&test4);
  61:	c7 04 24 24 0c 00 00 	movl   $0xc24,(%esp)
  68:	e8 83 00 00 00       	call   f0 <getPAddr>
    
    printf(1,"\n\nCreating Child Proces \n\n");
  6d:	58                   	pop    %eax
  6e:	5a                   	pop    %edx
  6f:	68 13 09 00 00       	push   $0x913
  74:	6a 01                	push   $0x1
  76:	e8 75 04 00 00       	call   4f0 <printf>
    if(fork() == 0)
  7b:	e8 0b 03 00 00       	call   38b <fork>
  80:	83 c4 10             	add    $0x10,%esp
  83:	85 c0                	test   %eax,%eax
  85:	75 3a                	jne    c1 <main+0xc1>
    {
        int test5 = test4;
        printf(1,"Parent's test1 variable in child Proces:\n");
  87:	50                   	push   %eax
        int test5 = test4;
  88:	8b 35 24 0c 00 00    	mov    0xc24,%esi
        printf(1,"Parent's test1 variable in child Proces:\n");
  8e:	50                   	push   %eax
  8f:	68 a0 08 00 00       	push   $0x8a0
  94:	6a 01                	push   $0x1
  96:	e8 55 04 00 00       	call   4f0 <printf>
        getPAddr((int)&test1);
  9b:	89 1c 24             	mov    %ebx,(%esp)
  9e:	e8 4d 00 00 00       	call   f0 <getPAddr>
        
        printf(1,"local variable in child:\n");
  a3:	58                   	pop    %eax
  a4:	5a                   	pop    %edx
  a5:	68 2e 09 00 00       	push   $0x92e
  aa:	6a 01                	push   $0x1
  ac:	e8 3f 04 00 00       	call   4f0 <printf>
        getPAddr((int)test5);
  b1:	89 34 24             	mov    %esi,(%esp)
  b4:	e8 37 00 00 00       	call   f0 <getPAddr>
  b9:	83 c4 10             	add    $0x10,%esp
    ...
    exit();
  bc:	e8 d2 02 00 00       	call   393 <exit>
        wait();
  c1:	e8 d5 02 00 00       	call   39b <wait>
        sleep(5);
  c6:	83 ec 0c             	sub    $0xc,%esp
  c9:	6a 05                	push   $0x5
  cb:	e8 53 03 00 00       	call   423 <sleep>
        printf(1,"local variable(newly created) in parent Process:\n");
  d0:	58                   	pop    %eax
  d1:	5a                   	pop    %edx
  d2:	68 cc 08 00 00       	push   $0x8cc
  d7:	6a 01                	push   $0x1
  d9:	e8 12 04 00 00       	call   4f0 <printf>
        getPAddr((int)test5);
  de:	59                   	pop    %ecx
  df:	ff 35 24 0c 00 00    	pushl  0xc24
  e5:	e8 06 00 00 00       	call   f0 <getPAddr>
  ea:	83 c4 10             	add    $0x10,%esp
  ed:	eb cd                	jmp    bc <main+0xbc>
  ef:	90                   	nop
...
000000f0 <getPAddr>:
{
  ...
  fb:	8b 5d 08             	mov    0x8(%ebp),%ebx
    int pa = v2paddr(va);
  fe:	53                   	push   %ebx
  ff:	e8 2f 03 00 00       	call   433 <v2paddr>
    if(pa != -1)
 104:	83 c4 10             	add    $0x10,%esp
 107:	83 f8 ff             	cmp    $0xffffffff,%eax
 10a:	74 11                	je     11d <getPAddr+0x2d>
        printf(1,"Physical address for VA: 0x%x is 0x%x\n\n", va, pa);
 10c:	50                   	push   %eax
 10d:	53                   	push   %ebx
 10e:	68 58 08 00 00       	push   $0x858
 113:	6a 01                	push   $0x1
...
printf(int fd, const char *fmt, ...)
{
 ...
 674:	eb 1a                	jmp    690 <printf+0x1a0>
          s = "(null)";
 676:	bb 48 09 00 00       	mov    $0x948,%ebx
        while(*s != 0){
...
free(void *ap)
{
 ...
 6c5:	a1 28 0c 00 00       	mov    0xc28,%eax
{
...
malloc(uint nbytes)
{
 ...
 75d:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 760:	8b 3d 28 0c 00 00    	mov    0xc28,%edi
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 7d2:	e8 e9 fe ff ff       	call   6c0 <free>
  return freep;
 7d7:	a1 28 0c 00 00       	mov    0xc28,%eax
 ...
 804:	89 72 04             	mov    %esi,0x4(%edx)
      freep = prevp;
 807:	a3 28 0c 00 00       	mov    %eax,0xc28
}
